...
Filters support equality, numeric ranges, typed IDs, and nested Boolean
conditions. Detailed results also identify the immutable root and report how
much exact or approximate work was performed.
